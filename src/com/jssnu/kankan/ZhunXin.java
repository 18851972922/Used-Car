...
public class ZhunXin extends JFrame {// 车辆估价窗体
	...
	private GujiaPanel getGujiaPanel()  {// 初始化loginPanel登录面板的方法
		if (gujiaPanel == null) {// 登录面板中没有组件时
			...
			jLabel.setText("准新车");// 设置“里程”标签的文本内容
			...
			try {
    				...
    				String sql = "SELECT * FROM cars_message where  miles<3 and age<3";
